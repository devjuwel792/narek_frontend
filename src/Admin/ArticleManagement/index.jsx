...
export default function ArticleManagement() {
  ...
  const articleData = data?.data?.results || [];
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-6  border border-gray-700/50 rounded-lg p-4">
          ...
          >
            <FiPlus className="text-xl" /> Add New Article
          </button>
        </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <button   onClick={() =>
                            window.open(
                              `${userSideUrl}/dispatch-detail/${item.id}`,
                              "_blank"
                            )
...
export function ContentForm({ fromType, data, onClose }) {
  ...
  useEffect(() => {
    if (fromType === "update" && data) {
      setFormData({
        ...
        article_1st_part: data.article_1st_part || "",
        special_quote: data.special_quote || "",
        article_2nd_part: data.article_2nd_part || "",
        tags: data.tags || [],
        banner_image: null,
        article_image: null,
        author_image: null,
  ...
  const handleRemoveArticleImage = () => {
    setFormData((prev) => ({ ...prev, article_image: null }));
    ...
    <div className="w-full  p-4">
      <div className="w-full  shadow-[0px_0px_40px_0px_rgba(255,57,176,.5)] bg-black rounded-2xl p-8  border-2 border-pink-500">
        <h1 className="text-white text-3xl font-bold mb-6">
          {fromType === "add" ? `Add New Article` : `Edit Article`}
        </h1>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <textarea
              name="article_1st_part"
              value={formData.article_1st_part}
              onChange={handleChange}
              placeholder="Enter first part of the article..."
              rows="5"
              className="w-full bg-zinc-900 text-white border border-zinc-700 rounded-lg px-4 py-3 focus:outline-none focus:border-pink-500 transition-colors resize-none placeholder-gray-500"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              name="article_2nd_part"
              value={formData.article_2nd_part}
              onChange={handleChange}
              placeholder="Enter second part of the article..."
              rows="5"
              className="w-full bg-zinc-900 text-white border border-zinc-700 rounded-lg px-4 py-3 focus:outline-none focus:border-pink-500 transition-colors resize-none placeholder-gray-500"
            />
          </div>
