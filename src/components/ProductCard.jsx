        ...
        <div>
          ...
          <div className="flex items-center justify-start gap-2">
            <button
              ...
              className="w-8 h-8 rounded border flex-1 border-gray-200 text-black hover:bg-green-50 flex items-center justify-center"
            >
            ...
            <button
              ...
              className="w-8 h-8 rounded border border-gray-200 text-black hover:bg-green-50 flex items-center justify-center flex-1"
            >
